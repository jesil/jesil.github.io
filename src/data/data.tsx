...
export const homePageMeta: HomepageMeta = {
  title: 'Jesil resume',
  description: "Read under the supervision of a child",
};
...
export const socialLinks: Social[] = [
  {label: 'Github', Icon: GithubIcon, href: 'https://github.com/jesil'},
  {label: 'Stack Overflow', Icon: StackOverflowIcon, href: 'https://stackoverflow.com/users/22984768/jesil-mohammed-nausher'},
  {label: 'LinkedIn', Icon: LinkedInIcon, href: 'https://www.linkedin.com/in/jesil-mohammed-nausher-a73820173/'},
  {label: 'Instagram', Icon: InstagramIcon, href: 'https://www.instagram.com/jez________/'},
